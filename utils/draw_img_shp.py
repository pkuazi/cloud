...
#     png_tif = '/tmp/FY4A-_AGRI--_N_REGC_1047E_L1-_FDI-_MULT_NOM_20200501064918_20200501065335_4000M_V0001_Img.tif'
#     cv2.imwrite(png_tif, cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
        # 绘图
...
#               extent=extent)
    ...
    plt.savefig(dstfig,dpi=600)

if __name__ == '__main__':
    tiffile = '/mnt/win/code/dataservice/cloud/results/FY4A-_AGRI--_N_REGC_1047E_L1-_FDI-_MULT_NOM_20200731043418_20200731043835_4000M_V0001_CLT.hdf'
    shpfile = '/mnt/win/code/dataservice/cloud/data/map/China_province.shp'
    geo_range_str = '5, 54.95, 70, 139.95, 0.05'
    dstfig = '/tmp/%s_Img.tif'%'fy4a_pred_0434'
    draw(tiffile, shpfile,geo_range_str,dstfig)
